...
# tracking. Computes returns, volatility, Sharpe, Sortino, maximum
# drawdown, and Calmar ratio with full data lineage.
#
...
def _get_module_logger():
    """Get module logger instance using the project logger."""
    return get_builtin_logger("metricscomputation")
